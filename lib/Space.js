(function() {
  ...
  */
  ...
  function wrapWithSlice(space, methodName) {
    return function() {
      return Array.prototype[methodName].apply(space.slice(), arguments);
    };
  }
  ...
  function Space(state, name, parent, oldSpace) {
    ...
    */
    ...
    if (space._isArray) {
      ...
      ['filter', 'map', 'slice', 'includes', 'join'].forEach(function(method) {
        Object.defineProperty(space, method, {
          value: Array.prototype[method],
        });
      });
      ['sort', 'concat'].forEach(function(method) {
        Object.defineProperty(space, method, {
