(function() {
  ...
  */
  ...
  function createRemoveFunc(space, causedBy) {
    return function remove(shouldRemove) {
      space = this._newSpace || space;
      var newState = toObj(
        space.filter(function(item, index) {
  ...
  */
      ...
      ['filter', 'map', 'slice'].forEach(function(method) {
        Object.defineProperty(space, method, {
          value: function() {
            ...
            return new Space(result, this._name, this._parent, this);
          },
        });
      });
  ...
  function sort(sorter) {
    // return new Space(this.slice().sort(sorter), this._name, this._parent, this);
    return toObj(this)
      .slice()
      .sort(sorter);
  }
